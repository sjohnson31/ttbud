    ...
    async getTests(tests, config) {
        ...
        for (const test of tests) {
            for (const browser of browsers) {
                ...
                const wsEndpoint = await this.launchServer(browserConfig, ((_a = utils_1.getBrowserOptions(browserType, connectOptions)) === null || _a === void 0 ? void 0 : _a.wsEndpoint) || null, browserType, key, instance);
                const browserTest = {
                    test: test,
